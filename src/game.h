...
void B_BloodDraw(Si16, Si16, void *);
void B_SmokeDraw(Si16, Si16, void *);
void B_Smoke2Draw(Si16, Si16, void *);
void B_GilzaDraw(Si16, Si16, void *);
void B_ShellDraw(Si16, Si16, void *);
void B_ArrowDraw(Si16, Si16, void *);
void B_NapalmDraw(Si16, Si16, void *);
void B_RocketDraw(Si16, Si16, void *);
void B_PhotoHorzDraw(Si16, Si16, void *);
void B_PhotoVertDraw(Si16, Si16, void *);
void B_GrenadeDraw(Si16, Si16, void *);
void B_RedmerDraw(Si16, Si16, void *);
void B_LaserDraw(Si16, Si16, void *);
void B_AimDraw(Si16, Si16, void *);
void B_BallDraw(Si16, Si16, void *);
...
void I_HealthDraw(Si16, Si16, void *);
void I_ArmourDraw(Si16, Si16, void *);
void I_PistolAmmoDraw(Si16, Si16, void *);
void I_BowDraw(Si16, Si16, void *);
void I_BowAmmoDraw(Si16, Si16, void *);
void I_AkmDraw(Si16, Si16, void *);
void I_AkmAmmoDraw(Si16, Si16, void *);
void I_NapalmDraw(Si16, Si16, void *);
void I_NapalmAmmoDraw(Si16, Si16, void *);
void I_LauncherDraw(Si16, Si16, void *);
void I_LauncherAmmoDraw(Si16, Si16, void *);
void I_PhotoDraw(Si16, Si16, void *);
void I_GrenadeDraw(Si16, Si16, void *);
void I_RedmerDraw(Si16, Si16, void *);
void I_LaserDraw(Si16, Si16, void *);
void I_LaserAmmoDraw(Si16, Si16, void *);
void I_CorpseDraw(Si16, Si16, void *);
void I_PackDraw(Si16, Si16, void *);
